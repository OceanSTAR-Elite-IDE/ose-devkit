...
export declare type FadeAnimationSteps = { from: any, to: any };
...
export function fade(options: FadeAnimationOptions): AnimationReferenceMetadata {
  return animation(
    ...
    keyframes([
      style({ opacity: `${options.fromOpacity}`, transform: translate3d(options.axis, options.steps.from), offset: 0 }),
      style({ opacity: `${options.toOpacity}`, transform: translate3d(options.axis, options.steps.to), offset: 1 }),
    ])
  ));
}
...
export function fadeIn(timing?: number, delay?: number) {
  return fadeInX({ from: 0, to: 0 }, timing, delay);
}
...
export function fadeInDown(timing?: number, delay?: number) {
  return fadeInY({ from: '-100%', to: 0 }, timing, delay);
}
...
export function fadeInLeft(timing?: number, delay?: number) {
  return fadeInX({ from: '-100%', to: 0 }, timing, delay);
}
...
export function fadeOut(timing?: number, delay?: number) {
  return fadeOutX({ from: 0, to: 0 }, timing, delay);
}
...
export function fadeOutDown(timing?: number, delay?: number) {
  return fadeOutY({ from: '-100%', to: 0 }, timing, delay);
}
...
export function fadeOutLeft(timing?: number, delay?: number) {
  return fadeOutX({ from: '-100%', to: 0 }, timing, delay);
}
...
export function slideInDown(timing?: number, delay?: number) {
  return slideY({ from: '100%', to: 0 }, timing, delay);
}
...
export function slideInLeft(timing?: number, delay?: number) {
  return slideX({ from: '-100%', to: 0 }, timing, delay);
}
...
export function slideOutUp(timing?: number, delay?: number) {
  return slideY({ from: 0, to: '-100%' }, timing, delay);
}
...
export function slideOutLeft(timing?: number, delay?: number) {
  return slideX({ from: 0, to: '-100%' }, timing, delay);
}
