  ...
  implements OnInit, OnDestroy, ControlValueAccessor, Validator
{
  ...
  get value(): D | null {
    return this._model ? this._getValueFromModel(this._model.selection) : this._value;
  }
  ...
  private _parseValidator: ValidatorFn = (): ValidationErrors | null => {
    return this._lastValueValid ? null : { NcDatePickerParse: { text: this.value } };
  };
  ...
  private _filterValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
    ...
    return !dateFilter || !controlValue || dateFilter(controlValue) ? null : { NcDatePickerFilter: true };
  };
