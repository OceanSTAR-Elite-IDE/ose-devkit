...
import { NcCalendarBody, NcCalendarCell, NcCalendarCellClassFunction, NcCalendarUserEvent } from './calendar-body';
import { createMissingDateImplError } from './datepicker-errors';
import { DateRange, NC_DATE_RANGE_SELECTION_STRATEGY, NcDateRangeSelectionStrategy } from './selections';
...
@Component({
  imports: [CommonModule, NcCalendarBody],
...
export class NcCalendarMonth<D> implements AfterContentInit, OnChanges, OnDestroy {
  ...
  private _fillAfterCells(): void {
    ...
    const dateNames = this._dateAdapter.getDateNames();
    const afterWeeks: NcCalendarCell[] = [],
      afterRows: NcCalendarCell[] = [];
